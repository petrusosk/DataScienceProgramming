...
The work is beneficial for preprocessing, transparent models, and evaluation metrics. The project report is an example of developing a predictor of a binary classification problem with an imbalanced data set. 
